...
masker = utils.NamedEntityMasker(args.mask_ner)

train_set = utils.FakeSet('data/train.json', sep=tokenizer.sep_token, masker=masker, verbose=args.verbose)
dev_set = utils.FakeSet('data/dev.json', sep=tokenizer.sep_token, masker=masker, verbose=args.verbose)
